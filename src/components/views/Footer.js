...
function Footer() {
  ...
  return (
    ...
    >
      <Grid
        container
        sx={{ backgroundColor: backgroundColor, marginLeft: "-1px" }}
        spacing={2}
        id="footer"
      >
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <a
              href="https://twitter.com/GamutExchange"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://discord.com/invite/5vHPEFSe7Y"
              target="_blank"
              rel="noreferrer"
            >
              <img
